...
if sekcja == 'Analiza korespondencji':
    ...
    st.subheader('Imiona żeńskie')
    st.image('imionaa/PI1/zk1.png')
    st.image('imionaa/PI1/zk2.png')
    st.image('imionaa/PI1/zk3.png')
    st.image('imionaa/PI1/zk4.png')
    st.image('imionaa/PI1/zk5.png')
    st.image('imionaa/PI1/zk6.png')
    st.image('imionaa/PI1/zk7.png')
    st.image('imionaa/PI1/zk8.png') 
    st.image('imionaa/PI1/zk9.png')
    st.image('imionaa/PI1/zk10.png')
    st.image('imionaa/PI1/zk11.png')
    st.image('imionaa/PI1/zk12.png')
    st.image('imionaa/PI1/zk13.png')
    st.image('imionaa/PI1/zk14.png')
    st.image('imionaa/PI1/zk15.png')
    st.image('imionaa/PI1/zk16.png')
		  
    st.subheader('Imiona męskie')
    st.image('imionaa/PI1/zm1.png')
    st.image('imionaa/PI1/zm2.png')
    st.image('imionaa/PI1/zm3.png')
    st.image('imionaa/PI1/zm4.png')
    st.image('imionaa/PI1/zm5.png')
    st.image('imionaa/PI1/zm6.png')
    st.image('imionaa/PI1/zm7.png')
    st.image('imionaa/PI1/zm8.png') 
    st.image('imionaa/PI1/zm9.png')
    st.image('imionaa/PI1/zm10.png')
    st.image('imionaa/PI1/zm11.png')
    st.image('imionaa/PI1/zm12.png')
    st.image('imionaa/PI1/zm13.png')
    st.image('imionaa/PI1/zm14.png')
    st.image('imionaa/PI1/zm15.png')
    st.image('imionaa/PI1/zm16.png')
