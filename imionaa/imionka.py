...
if sekcja == 'Strona główna':
    ...
    st.plotly_chart(px.line(im[im['Imię']==imie].sort_values(['Płeć','Rok']),x='Rok',y='Liczba',color='Płeć',markers=True,width=1100, height=600).update_yaxes(rangemode='tozero'))
...
if sekcja == 'Wyniki analizy statystycznej':
    ...
    st.plotly_chart(px.line(imionka,x='Rok',y='Liczba',color='Imię',markers=True,width=1100, height=600).update_yaxes(rangemode='tozero'))
