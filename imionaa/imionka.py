...
if sekcja == 'Analiza statystyczna':
    ...
    if imionka.empty:
	    ...
	    st.plotly_chart(px.line(imionka2.sort_values(['Rok']),x='Rok',y='Liczba',color='Nowa2',markers=True,width=1100, height=600,color_discrete_sequence=list(map(lambda x: kol2[x], koly))).update_xaxes().update_yaxes(rangemode='tozero'))
