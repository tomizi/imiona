...
if sekcja == 'Wyniki analizy statystycznej':
    ...
    st.plotly_chart(px.line(imionka,x='Rok',y='Liczba',color='Imię',markers=True,width=1100, height=600).update_xaxes(range=[2000,2021]).update_yaxes(rangemode='tozero'))
