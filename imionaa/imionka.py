...
if sekcja == 'Analiza korespondencji':
    ...
    st.image('imionaa/PI/zk2.png')
    st.image('imionaa/PI/zk3.png')
    st.image('imionaa/PI/zk4.png')
    st.image('imionaa/PI/zk5.png')
    st.image('imionaa/PI/zk6.png')
    st.image('imionaa/PI/zk7.png')
    st.image('imionaa/PI/zk8.png') 
    st.image('imionaa/PI/zk9.png')
    st.image('imionaa/PI/zk10.png')
    st.image('imionaa/PI/zk11.png')
    st.image('imionaa/PI/zk12.png')
    st.image('imionaa/PI/zk13.png')
    st.image('imionaa/PI/zk14.png')
    st.image('imionaa/PI/zk15.png')
    st.image('imionaa/PI/zk16.png')
		  
    st.subheader('Imiona męskie')
    st.image('imionaa/PI/zm1.png')
    st.image('imionaa/PI/zm2.png')
    st.image('imionaa/PI/zm3.png')
    st.image('imionaa/PI/zm4.png')
    st.image('imionaa/PI/zm5.png')
    st.image('imionaa/PI/zm6.png')
    st.image('imionaa/PI/zm7.png')
    st.image('imionaa/PI/zm8.png') 
    st.image('imionaa/PI/zm9.png')
    st.image('imionaa/PI/zm10.png')
    st.image('imionaa/PI/zm11.png')
    st.image('imionaa/PI/zm12.png')
    st.image('imionaa/PI/zm13.png')
    st.image('imionaa/PI/zm14.png')
    st.image('imionaa/PI/zm15.png')
    st.image('imionaa/PI/zm16.png')
