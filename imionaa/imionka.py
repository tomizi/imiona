...
if sekcja == 'Strona główna':
    ...
    st.dataframe([im[im['Imię']==imie].sort_values(['Rok','Płeć'])['Płeć'][index] for index in sorted(np.unique(im[im['Imię']==imie].sort_values(['Rok','Płeć'])['Płeć'], return_index=True)[1])])))
