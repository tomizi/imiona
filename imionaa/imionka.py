...
if sekcja == 'Strona główna':
    ...
    st.plotly_chart(px.line(im[im['Imię']==imie],x='Rok',y='Liczba',color='Płeć',markers=True,width=1100, height=600).update_yaxes(rangemode='nonnegative'))
...
if sekcja == 'Wyniki analizy statystycznej':
    ...
    st.subheader('Pierwsza litera - imiona żeńskie')
    c1, c2 = st.columns(2)
    with c1:
