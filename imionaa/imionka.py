...
if sekcja == 'Analiza statystyczna':
    ...
    koly = list(map(lambda x, y: x[0]+str(y),sorted(list(imionka2.sort_values(['Rok','Nowa2']).unique())),list(range(len(list(sorted(list(imionka2.sort_values(['Rok','Nowa2']).unique()))) ))) ))
    st.dataframe(koly)
    if imionka.empty:
