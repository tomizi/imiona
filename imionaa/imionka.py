...
if sekcja == 'Analiza statystyczna':
    ...
    st.plotly_chart(px.line(imionka3.sort_values(['Rok','Imię']),x=sorted(list(imionka3['Rok'])),y='Liczba',color='Imię',markers=True,width=1100, height=600).update_xaxes(tickmode='array').update_yaxes(rangemode='tozero'))
