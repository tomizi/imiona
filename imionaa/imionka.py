...
if sekcja == 'Analiza statystyczna':
    ...
    st.plotly_chart(px.line(imionka2.sort_values(['Rok','Nowa2']),x='Rok',y='Liczba',color='Nowa2',markers=True,width=1100, height=600,color_discrete_sequence=kol2[koly0]).update_xaxes(range=['1999-6','2022-6']).update_yaxes(rangemode='tozero'))
    if (imie1 in list(im['Imię']))  and (imie2 in list(im['Imię']) ):
