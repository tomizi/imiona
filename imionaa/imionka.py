...
if sekcja == 'Analiza statystyczna':
    ...
    c1.plotly_chart(px.bar(top10_k, x="Liczba", y="Imię", orientation='h',color='rgb(255,0,205)',
             height=600,
    ...
    c2.plotly_chart(px.bar(top10_m, x="Liczba", y="Imię", orientation='h',color='rgb(0,70,180)',
             height=600,
